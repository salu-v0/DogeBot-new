...
nomorowner1 = "@994401307215"; // Script by Xeon 
// ꪶ͢sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩
// ©Xeon Bot Incorporated
const {
  WAConnection: _WAConnection,
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`380945798078@s.whatsapp.net`]
...
/*const reply = (teks) => {
			xeon.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 359996400, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/380945798078?text=hello`}}})
		}*/
...
xeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      xeon.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = xeon.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `Xeon Bot Inc.`, "footerText": "*_ꪶ͢sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩⁩_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`ꪶ͢sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩⁩`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":359996400,"isForwarded":true},sendEphemeral: true})}
// Katalog
const reply = (teks) => {
...
const fakewa = (teks) => {        
xeon.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 359996400, isForwarded: true, externalAdReply:{title: `Xeon`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/380945798078?text=hello`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nꪶ͢sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩⁩. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/380945798078`,
                "mediaType": "10",
                "mediaUrl": `wa.me/380945798078`,
                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/380945798078`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "380945798078@s.whatsapp.net";
...
const serialUser = createSerial(18)
	        ...
	        addRegisteredUser(sender, serialUser)
	         const anuu = `「 *ᴜsᴇʀ ʀᴇɢɪsᴛʀᴀᴛɪᴏɴ* 」
*ᴛʜᴀɴᴋ ʏᴏᴜ ғᴏʀ ʀᴇɢɪsᴛᴇʀɪɴɢ ɪɴ ᴛʜᴇ ī.ᴀᴍ/ꪶ͢sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩ ᴅᴀᴛᴀʙᴀsᴇ*
...
*「 ꪶ͢sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩⁩ 」*`
	    ...
	    // console.log(e)
			...
			reply(`*ᴛʜᴀɴᴋ ʏᴏᴜ ғᴏʀ ʙᴇɪɴɢ ʀᴇɢɪsᴛᴇʀᴇᴅ ꪶ͢sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩⁩*`)
		}, 2000)
        break
...
groups = xeon.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "380945798078@s.whatsapp.net"
        dtod = '380945798078'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
case 'bugreport':
              ...
              xeon.sendMessage('380945798078@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
break
case 'h':
reply('© ɪᴀᴍ sᴋ ᴅᴇᴠɪʟ sᴇʀ 𝄒 😏')
break
case 'okeyx':
reply('💞𝑰 𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑯𝑬 𝑵𝑬𝑾 𝑴𝑬𝑴𝑩𝑬𝑹 💞 ꪶ͢𝑺𝑲 𝑫𝑬𝑽𝑰𝑳 𝑺𝑬𝑹⁩ꫂ⁩ Join our group🤗 https://chat.whatsapp.com/I8lMlox6meJJyQ5t82bFqf')
break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
 ...
 description: `ʜɪ @${sender.split('@')[0]}, ʜɪ ʙʀᴏ ᴛʜɪs ɪs ī.ᴀᴍ sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩ ᴍᴇɴᴜ

     ʜɪ ʙʀᴏ  😊🌝     
╔➱ᴄʀᴇᴀᴛᴏʀ⟼ꪶ͢sᴀʟᴍᴀɴ ᴏғᴄꫂ⁩
║
║➫ᴠᴇʀsɪᴏɴ⟼ 1.0
║
║➫ʙᴏᴛɴᴀᴍᴇ⟼ī.ᴀᴍ sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩
║
║➫ᴘʀᴇғɪx⟼(ᴍᴜʟᴛɪ ᴘʀᴇғɪx)
║
║➫ᴍᴏᴅᴇ⟼ ᴘᴜʙʟɪᴄ
     ...
     break
        ...
        case "broadcast":  
                   if (!isOwner && !mek.key.fromMe) return reply('only owner can use this feature')    
					...
					buff = await xeon.downloadMediaMessage(encmedia)
					for (let _ of anu) {
						xeon.sendMessage(_.jid, buff, image, {quoted:fakestatus ,caption: `「  *ꪶ͢sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩⁩ BROADCAST* 」\n\n${ini_bc}`})
					}
					reply('```Success Broadcast```')
					} else {
					for (let _ of anu) {
					xeon.sendMessage(_.jid, `*ꪶ͢sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩⁩ BROADCAST*\n${ini_bc}`, text, { contextInfo: { mentionedJid: [sender],"forwardingScore":359996400,"isForwarded":true},sendEphemeral: true })
					}
					reply('```Success Broadcast```')
					}
					break
...
sendButMessage(from, tiyo, `ꪶ͢sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩⁩`, [
            {              
   ...
   case 'bc':
      case 'broadcast':
        if (!mek.key.fromMe) return;
             ...
             for (let _ of anu) {
             xeon.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 ꪶ͢sᴋ ᴅᴇᴠɪʟ sᴇʀꫂ⁩⁩ BROADCASTING 」*\n\n${body.slice(4)}`})
}
